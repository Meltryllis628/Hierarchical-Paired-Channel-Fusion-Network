...
class HPCFNet_small(nn.Module):
    def __init__(self) -> None:
        super(HPCFNet_small, self).__init__()
        self.conv_1_2_a = ConvBlock(3, 32, stride=1)
        self.conv_1_2_b = ConvBlock(3, 32, stride=1)
        self.conv_2_2_a = ConvBlock(32, 64)
        self.conv_2_2_b = ConvBlock(32, 64)
        self.conv_3_3_a = ConvBlock(64, 128)
        self.conv_3_3_b = ConvBlock(64, 128)
        self.conv_4_3_a = ConvBlock(128, 256)
        self.conv_4_3_b = ConvBlock(128, 256)
        self.conv_5_3_a = ConvBlock(256, 256)
        self.conv_5_3_b = ConvBlock(256, 256)
        self.pcf_1 = PCF(256, False)
        self.rsa_1 = RSA(256)
        self.conv_1 = ConvBlock(512, 256, stride=1)
        self.mpfl_1 = MPFL(256)
        self.deconv_1 = nn.ConvTranspose2d(512, 256, kernel_size=2, stride=2)
        self.pcf_2 = PCF(256, True)
        self.rsa_2 = RSA(256)
        self.conv_2 = ConvBlock(768, 256, stride=1)
        self.mpfl_2 = MPFL(256)
        self.deconv_2 = nn.ConvTranspose2d(512, 128, kernel_size=2, stride=2)
        self.pcf_3 = PCF(128, True)
        self.rsa_3 = RSA(128)
        self.conv_3 = ConvBlock(384, 128, stride=1)
        self.mpfl_3 = MPFL(128)
        self.deconv_3 = nn.ConvTranspose2d(256, 64, kernel_size=2, stride=2)
        self.pcf_4 = PCF(64, True)
        self.rsa_4 = RSA(64)
        self.conv_4 = ConvBlock(192, 64, stride=1)
        self.mpfl_4 = MPFL(64)
        self.deconv_4 = nn.ConvTranspose2d(128, 32, kernel_size=2, stride=2)
        self.pcf_5 = PCF(32, True)
        self.conv_5 = ConvBlock(96, 32, stride=1)
        self.conv_6 = ConvBlock(32, 2, stride=1, kernel_size=1, padding=0)
...
class HPCFNet_tiny(nn.Module):
    def __init__(self) -> None:
        ...
        self.conv_6 = ConvBlock(16, 2, stride=1, kernel_size=1, padding=0)
